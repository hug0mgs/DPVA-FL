...
# NOVAS IMPORTAÇÕES DOS SERVIDORES COM DP
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # select algorithm
        # Converte o nome do algoritmo para minúsculas para consistência
        algo = args.algorithm.lower()

        if algo == "fedavg":
            # Se o modo DP for 'none', usa o servidor FedAvg original.
            # Caso contrário, usa o novo servidor FedAvg_DP.
            ...
            # Lógica similar para o SCAFFOLD
            if args.dp_mode == 'none':
...
# ==================== NOVOS ARGUMENTOS PARA O SEU PROJETO DE TESE ====================
    ...
    parser.add_argument('-dpe', '--dp_epsilon', type=float, default=5.0,
    ...
    parser.add_argument('-dpgn', '--dp_max_grad_norm', type=float, default=1.0,
                        help='Norma máxima para o clipping de gradientes por amostra (parâmetro do Opacus).')
    
    # Parâmetros para o modo adaptativo
    parser.add_argument('-dpemax', '--dp_epsilon_max', type=float, default=10.0,
                        help='Epsilon máximo para o modo adaptativo.')
    parser.add_argument('-dpemin', '--dp_epsilon_min', type=float, default=1.0,
