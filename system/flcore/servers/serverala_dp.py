...
import torch
import numpy as np
from flcore.clients.clientala_dp import clientALA_DP
...
class FedALA_DP(ServerDPBase):
    def __init__(self, args, times):
        super().__init__(args, times)
        self.set_slow_clients()
        self.set_clients(clientALA_DP)
        ...
        print("Finished creating server and clients for FedALA with Differential Privacy.")
        ...
        for i in range(self.global_rounds + 1):
            ...
            if self.dp_mode != 'none':
                ...
                for client in self.selected_clients:
                    ...
                    # Coleta a atualização (delta_model) do cliente para cálculo da variância
